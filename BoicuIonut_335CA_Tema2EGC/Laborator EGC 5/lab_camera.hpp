...
namespace lab
{
	...
	public:
		...
		void rotateFPS_OX(float angle)
		{
			...
			// Use glm::rotate()
			forward=glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.0),angle,right)*glm::vec4(forward,1.0)));
			up = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.0),angle,right)*glm::vec4(up,1.0)));
		}
		...
		void rotateFPS_OY(float angle)
		{
			...
			forward=glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.0),angle,up)*glm::vec4(forward,1.0)));
			right=glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.0),angle,up)*glm::vec4(right,1.0)));
		}
		...
		void rotateFPS_OZ(float angle)
		{
			...
			// Atention! Don't forget to normalize the vectors
			// use glm::rotate()
			right = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.0),angle,forward)*glm::vec4(right,1.0)));
			up = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.0),angle,forward)*glm::vec4(up,1.0)));
		}
